...
import { idlFactory } from './kong_bot_frontend.did.js';
export { idlFactory } from './kong_bot_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_KONG_BOT_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./kong_bot_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the kong_bot_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./kong_bot_frontend.did.js")._SERVICE>}
 */
export const kong_bot_frontend = createActor(canisterId);
